...
none	LDA #$FF  ; maximum frequency value, finally made this work
...
scankey			
                 ...
                 jsr scnkey
		 		 ...
		 		 jsr getin 
		 	      bne setkey ; if something else, direct us off to a place where we can institute the new value
		 	     rts
				
setkey            sta currentdirection
                  rts
...
displaypageonesnakesegment		
                               
                                ldy snakesegmentsL,x
								sta $0400,y
